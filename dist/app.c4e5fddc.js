...
var Slider = function Slider() {
  ...
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      sliderContainerSelector = _ref$sliderContainerS === void 0 ? ".slider_container" : _ref$sliderContainerS,
      ...
      transitionTime = _ref$transitionTime === void 0 ? 3000 : _ref$transitionTime;

  _classCallCheck(this, Slider);

  _defineProperty(this, "moveSlides", function () {
    _this.sliderContainer.style.transform = "translateX(-".concat(_this.currentSlide * _this.slideSize, "px)");
  });

  _defineProperty(this, "nextSlide", function () {
    _this.currentSlide = _this.currentSlide >= _this.slides - 1 ? 0 : _this.currentSlide + 1;

    _this.moveSlides();
  });

  _defineProperty(this, "prevSlide", function () {
    _this.currentSlide = _this.currentSlide <= 0 ? _this.slides - 1 : _this.currentSlide - 1;

    _this.moveSlides();
  });

  _defineProperty(this, "setEventListener", function () {
    _this.prevBtn.addEventListener("click", _this.prevSlide);

    _this.nextBtn.addEventListener("click", _this.nextSlide);
  });
